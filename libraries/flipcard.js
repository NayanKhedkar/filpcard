 ...
 * By Pingmin Tech
 *
 * Documentation: http://pingmin-tech.com/flipcardjs

 * Copyright (c) 2013, Pingmin Tech. All rights reserved.
    ...
    $.fn.flip = function(options) {
        ...
        return this.each(function() {
            var containerEl = $(this),
                cardEl, frontEl, backEl, flipOptions, lastFlippedDir, transDir, autoflipdelaytime, autoflipstarttime;
            var mouseEventName, mouseLeaveEventStatus = "none",
                mouseEnterEventFlippingStatus = "flipped";
            ...
            function doit() {
                ...
                if (typeof options === "string") {
                    ...
                    } else if (flipOptions.flipOnHover === "true") {
                        containerEl.on("mouseenter", mouseEnterHandler);
                        containerEl.on("mouseleave", mouseLeaveHandler);
                    } else {
                        doFlip();
                    }
                }
            ...
            function mouseLeaveHandler() {
                if (mouseEnterEventFlippingStatus === "flipping") {
                    mouseLeaveEventStatus = "queued";
                } else {
                    mouseEventName = "mouseleave";
                    doFlip();
                }
            }
            ...
            function onTransitionEnd() {
                ...
                //on complete (after realase isanimating flag)
                if (flipOptions.flipOnHover === "true" && mouseEventName === "mouseenter") {
                    mouseEnterEventFlippingStatus = "flipped";
                    if (mouseLeaveEventStatus === "queued") {
                        mouseLeaveEventStatus = "none";
                        containerEl.trigger("mouseleave");
                    }
                }
            }
            ...
            function addTransitionEvent() {
                ...
                if (flipOptions.flipOnHover === "true" && mouseEventName === "mouseenter") {
                    mouseEnterEventFlippingStatus = "flipping";
                }
            }
